...
<body>
  <nav class="navbar navbar-expand-sm navbar-contrast">
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <ul class="nav col-md-4 justify-content-end d-flex">
      <li class="ms-3">
        <a href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="lightblue" hover="color:green" class="bi bi-facebook" viewBox="0 0 16 16">
      ...
      <li class="ms-3">
        <a href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="lightblue" class="bi bi-twitter" viewBox="0 0 16 16">
      ...
      <li class="ms-3">
        <a href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="lightblue" class="bi bi-instagram" viewBox="0 0 16 16">
